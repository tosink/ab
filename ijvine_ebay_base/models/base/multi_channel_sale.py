...
class MultiChannelSale(models.Model):
	...
	def display_message(self, message):
		return self.env['wizard.message'].genrated_message(message,'Summary')
	...
	def set_info_urls(self):
		for instance in self:
			...
			instance.blog_url = url_info.get('blog','https://ijvine.com/blog/')
			instance.store_url = url_info.get('store','https://www.ijvine.com/pricing')
	...
	use_api_limit = fields.Boolean(
		string = 'Use API Limit',
		default = True
	)
